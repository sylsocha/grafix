...
if(!isset($_SESSION['user'])){
    ...
    $sql1 = "select id_order from orders where id_user = '$_SESSION[user]'";
    $conn->query($sql1);
    ...
    if ($wynik->num_rows > 0) {
        ...
        $sql2 = "select id_order, finalised from orders where id_user = '$_SESSION[user]'";
        $conn->query($sql2);
    ...
    $sql5 = "select finalised as fin from orders where id_user = '$_SESSION[user]' and id_order='$nr_zamowienia'";
    $conn->query($sql5);
